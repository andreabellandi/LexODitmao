...
//    private List<SelectItem> PoS;
    ...
    private ArrayList<ReferenceData> referenceList;
    ...
    public ArrayList<ReferenceData> getReferenceList() {
...
//        taxonomy.add(new Ontology("----Uelh", "Uelh"));
    ...
    private void loadReferences() {
        ...
        referenceList.add(new ReferenceData("Dictionary", "", "DAO", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Dictionary", "", "LR", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Dictionary", "", "PSW", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Dictionary", "", "FEW", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Edition", "", "RM", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Edition", "", "RMA", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Edition", "", "RMM", "", "", "", "", "", "(Erb a)"));
        referenceList.add(new ReferenceData("Edition", "", "RPA", "", "", "", "", "", "(Erb a)"));
    }
