...
@ViewScoped
@Named
public class LexiconCreationDocumentFilterController extends BaseController implements Serializable {
    ...
    public void startsWithChanged() {
        contains = !startWith;
        if (lexiconCreationControllerTabViewList.getDocField() != null) {
            if (lexiconCreationControllerTabViewList.getDocField().length() > 0) {
                lexiconCreationControllerTabViewList.docKeyupFilterEvent(lexiconCreationControllerTabViewList.getDocField());
            }
        }
    }
