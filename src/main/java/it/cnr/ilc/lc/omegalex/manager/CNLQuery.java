...
import static it.cnr.ilc.lc.omegalex.manager.LexiconQuery.QUERY_PREFIXES;
...
public class CNLQuery extends LexiconQuery {
    ...
    public List<Map<String, String>> ontoQueryGroup_1_lemmas(String ontoClass) {
        return processQuery(QUERY_PREFIXES + TEMPLATE_CONCEPT_GROUP_1_LEMMA);
    }

    public List<Map<String, String>> ontoQueryGroup_1_forms(String ontoClass) {
        return processQuery(QUERY_PREFIXES + TEMPLATE_CONCEPT_GROUP_1_FORM);
    }
